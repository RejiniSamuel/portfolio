           ...
           <div className="row">
            <div className="col-lg-12">
                 <div id="content" className="tc pv4 pv5-ns">
                        ...
                        <h1 className="textShadow f1-ns fw10 white-100 tracked">Rejini Samuel</h1>
                         <img alt='' src="https://s3.us-east-2.amazonaws.com/picturesforanyone/images/rejiniPic.png"  className="br3 ba b--black-10 br-100 h4 w4" title="" />
                          <h3 className="textShadow f4 white-100 fw4 ttu tracked">IT Professional</h3>
                </div>
                <hr />
            </div>
            </div>
